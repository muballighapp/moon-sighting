...
namespace Muballigh\MoonSighting\Tests\Unit;

use Muballigh\MoonSighting\Fajr;
...
class MoonSightingTest extends TestCase
{
    public function testDYYNorthFajr()
    {
        ...
        echo "\nDYY: " . $pt->getDyy();
        echo "\nHemisphere: " . $pt->hemisphere;
        echo "\nMinutes Before Sunrise: " . $pt->getMinutesBeforeSunrise();
    ...
    public function testDYYNorthIsha()
    {
        ...
        echo "\nDYY: " . $pt->getDyy();
        echo "\nHemisphere: " . $pt->hemisphere;
        echo "\nMinutes Before Sunrise: " . $pt->getMinutesAfterSunset();
